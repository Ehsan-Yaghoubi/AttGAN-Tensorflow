...
# paths
rap_images_dir = '../../RAP_images'
rap_masks_dir = '../../RAP_masks'
rap_keypoints_json = '../rap_annotations/RAP_keypoints.json'
rap_attribute_annotations = '../rap_annotations/RAP_annotation.mat'
...
def load_rap_dataset(rap_attributes_filepath, rap_keypoints_json):
...
if __name__ == '__main__':
    rap_data = load_rap_dataset(rap_attribute_annotations, rap_keypoints_json)
